    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow py-16">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl font-extrabold text-center mb-12">Məxfilik Siyasəti</h1>

          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Toplanan Məlumat</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Məlumatların Təhlükəsizliyi</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Kukilər (Cookies)</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Məlumatların Üçüncü Tərəflərə Verilməsi</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Məlumatların Silinməsi</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Dəyişikliklər</h2>
            <p className="text-lg leading-relaxed">
