...
/>
      ...
      <div className="flex flex-col lg:flex-row max-w-6xl mx-auto justify-center items-start gap-8 my-12 px-4 lg:px-12">
        {/* Left: Price Options */}
        ...
        <div className="bg-white w-full lg:w-1/2 flex flex-col items-start justify-start p-6 lg:p-12 rounded-xl shadow-lg border border-gray-200">
          <h3 className="text-xl lg:text-2xl font-semibold mb-6">Ödəniş Detalları</h3>
          <div className="space-y-4">
            <p className="text-lg lg:text-xl font-medium">
              Seçilən İmtahan: <span className="font-normal">{examName || 'Adı mövcud deyil'}</span>
            </p>
            <p className="text-lg lg:text-xl font-medium">
              Ödəniləcək məbləğ: <span className="font-medium text-green-400">{selectedPrice ? `₼${selectedPrice}.00` : 'Seçilməyib'}</span>
            </p>
          </div>
          <div className="mt-6 space-y-3">
            ...
            {/* DaisyUI Checkbox for accepting terms */}
            <div className="form-control">
              <label className="label cursor-pointer justify-start gap-3">
                <input
                  type="checkbox"
                ...
                <span className="label-text text-base">
                  <Link to="/paymentConditions">
                    <span className="text-blue-600">Ödəniş şərtlərini</span>
                  </Link>{' '}
                  qəbul edirəm
                </span>
              </label>
