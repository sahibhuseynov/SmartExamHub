    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow py-16">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl font-extrabold text-center mb-12">İstifadə Şərtləri</h1>

          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Ümumi Məlumat</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Hesab Yaradılması və Təhlükəsizlik</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Xidmətlərdən İstifadə</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">İstifadəçi Hüquqları və Vəzifələri</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Şərtlərdə Dəyişikliklər</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Məsuliyyət</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Əlaqə</h2>
            <p className="text-lg leading-relaxed">
