        ...
        <div className="max-w-6xl mx-auto">
          ...
          <section className="mb-8">
            ...
            <p className="text-lg leading-relaxed">
              İstifadəçi <span className="font-bold">Balabebir.az</span> platformasında təqdim olunan xidmətlərdən istifadə etməklə bu
          ...
          <section className="mb-8">
            ...
            <p className="text-lg leading-relaxed">
              <span className="font-bold">Balabebir.az</span> saytında yerləşdirilən tədris materiallarının keyfiyyətinə görə məsuliyyət müəllifə aiddir.
              İstifadəçinin şikayəti varsa, bu cür müraciətlər birbaşa müəllifə ünvanlanmalıdır. Ödənilən vəsaitlər <span className="font-bold">Balabebir MMC</span>
          ...
          <section className="mb-8">
            ...
            <p className="text-lg leading-relaxed">
              <span className="font-bold">Balabebir MMC</span> kart məlumatlarınızı saxlamır və paylaşmır. Məlumatlarınızın qorunması üçün qabaqcıl
