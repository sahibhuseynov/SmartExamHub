...
<div className="fixed bottom-5 right-5 z-50">
  <AnimatePresence mode='popLayout'>
    ...
    {isOpen && (
      <motion.div
        key="chat"
        className="bg-white w-96 h-[500px] shadow-xl rounded-2xl flex flex-col"
      ...
      >
        ...
        <div className="bg-blue-500 text-white p-4 rounded-t-2xl flex justify-between items-center">
          ...
          >
            ...
            <motion.button
              type="submit"
              className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors disabled:opacity-50"
              whileTap={{ scale: 0.95 }}
              disabled={isLoading}
            >
              {isLoading ? '...' : 'Gönder'}
